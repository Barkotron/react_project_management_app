...
function App() {
  ...
  tasks={projectsState.tasks.filter((task) => task.projectId === projectsState.selectedProjectId)}></SelectedProject>;
  ...
  return (
    <main className="h-screen my-8 flex gap-8">
      ...
      selectedProjectId={projectsState.selectedProjectId}></ProjectsSidebar>
      {content}
